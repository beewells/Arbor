    ...
    <ScrollView>
        ...
        <View style = {styles.outline}>
                <View style = {styles.background}>
                    <Image style = {styles.picture} source = {require('/Users/blainekwells/Desktop/Arbor/assets/images/Stock/SanFran.jpeg')} />
                </View>
        </View>
        ...
        <View style = {styles.outline}>
                <View style = {styles.textBackground}>
                    ...
                    Exploring San Francisco's iconic Golden Gate Bridge, vibrant Fisherman's Wharf, and historic cable cars, immersed in diverse cultural charm.
                    </Text>
                </View>
        </View>
        ...
        <View style = {styles.outline}>
                <View style = {styles.textBackground}>
                    <Text style = {styles.words}> 
                        * Excitement - Thrilled by the city's landmarks. 
                    </Text>
                    <Text style = {styles.words}> 
                        * Curiosity - Intrigued by San Francisco's rich history and cultural diversity.
                    </Text>
                </View>
        </View>
