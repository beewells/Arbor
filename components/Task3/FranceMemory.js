    ...
    <ScrollView>
        ...
        <View style = {styles.outline}>
                <View style = {styles.background}>
                    <Image style = {styles.picture} source = {require('/Users/blainekwells/Desktop/Arbor/assets/images/Stock/Paris.jpeg')} />
                </View>
        </View>
        ...
        <View style = {styles.outline}>
                <View style = {styles.textBackground}>
                    ...
                    Strolling through the romantic streets of Paris, marveling at the iconic Eiffel Tower and the Louvre, savoring exquisite French cuisine.
                    </Text>
                </View>
        </View>
        ...
        <View style = {styles.outline}>
                <View style = {styles.textBackground}>
                    <Text style = {styles.words}> 
                        * Wonder - Awed by the rich history and stunning architecture.
                    </Text>
                    <Text style = {styles.words}> 
                        * Contentment - Relishing the charming Parisian ambiance.
                    </Text>
                </View>
        </View>
