...
const FullMemory = ( {navigation} ) => {
  ...
  return (
    ...
    <Text style = {styles.title}> Korea Trip</Text>
    ...
    <ScrollView>
        ...
        <View style = {styles.outline}>
                <View style = {styles.background}>
                    <Image style = {styles.picture} source = {require('/Users/blainekwells/Desktop/Arbor/assets/images/Stock/Korea.webp')} />
                </View>
        </View>
        ...
        <View style = {styles.outline}>
                <View style = {styles.textBackground}>
                    <Text style = {styles.words}> 
                        Spent over a month in Korea with some friends! Explored Seoul and Busan and ate lots of delicious food.
                    </Text>
                </View>
        </View>
        ...
        <View style = {styles.outline}>
                <View style = {styles.textBackground}>
                    <Text style = {styles.words}> 
                        * Excitement! I love experiencing new things!
                    </Text>
                    <Text style = {styles.words}> 
                        * Nervous because I barely understand Korean. 
                    </Text>
                </View>
        </View>
