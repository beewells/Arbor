...
const CreateStart = ( {navigation} ) => {
  ...
  return (
    ...
    <Text style = {styles.descriptor}> Memory Name </Text>
        ...
        <View style={styles.outline}>
          <TouchableOpacity 
            ...
            style={[styles.background, { backgroundColor: selectedMedia ? selectedColor : defaultColor }]}
          >
                {selectedMedia ? (
              mediaType === 'video' ? (
                <Video 
    ...
    <TouchableOpacity activeOpacity={1} onPress={navigateToDescription} disabled={!isNextButtonEnabled}>
        <View style = {[styles.nextOutline, {opacity: isNextButtonEnabled ? 1 : 0.5}]}>
