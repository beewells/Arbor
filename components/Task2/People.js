...
const People = ( {route, navigation} ) => {
  ...
  const navigateToEmotions = () => {
    navigation.navigate('Emotions', {people: people, description: description, memoryName: memoryName, selectedMedia: selectedMedia});
  };
  ...
  const isNextButtonEnabled = people; 
  return (
    <ImageBackground
    ...
    <View style = {styles.buttons}>
        <TouchableOpacity activeOpacity={1} onPress={navigateToDescription}>
        ...
        <TouchableOpacity activeOpacity={1} onPress={navigateToEmotions} disabled={!isNextButtonEnabled}>
