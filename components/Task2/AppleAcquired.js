...
const AppleAcquired= ( {navigation} ) => {
  ...
  return (
    ...
    <View style={styles.headerContainer}>
        ...
        <Text style = {styles.heading}> Apple Seed Acquired! </Text>
        <Image style = {styles.fruit} source = {require('/Users/blainekwells/Desktop/Arbor/assets/images/GIFs/SeedApple.gif')} />
