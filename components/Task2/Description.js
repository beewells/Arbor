...
const Description = ( {route, navigation} ) => {
  ...
  const navigateToPeople = () => {
    navigation.navigate('People', { description: description, memoryName: memoryName, selectedMedia: selectedMedia});
  };
  ...
  const isNextButtonEnabled = description; 
  return (
    <ImageBackground
    ...
    <View style = {styles.buttons}>
        ...
        <TouchableOpacity activeOpacity={1} onPress={navigateToPeople} disabled={!isNextButtonEnabled}>
