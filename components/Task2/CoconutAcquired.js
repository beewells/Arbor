...
const CoconutAcquired= ( {navigation} ) => {
  ...
  return (
    ...
    <View style={styles.headerContainer}>
        ...
        <Text style = {styles.heading}> Coconut Seed Acquired! </Text>
        <Image style = {styles.fruit} source = {require('/Users/blainekwells/Desktop/Arbor/assets/images/GIFs/SeedCoconut.gif')} />
...
export default CoconutAcquired;
