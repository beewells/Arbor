...
const PeachAcquired = ( {navigation} ) => {
  ...
  return (
    ...
    <View style={styles.headerContainer}>
        ...
        <Text style = {styles.heading}> Peach Seed Acquired! </Text>
        <Image style = {styles.fruit} source = {require('/Users/blainekwells/Desktop/Arbor/assets/images/GIFs/SeedPeach.gif')} />
